...
function App() {
  return (
    <div className="min-h-screen w-full flex flex-col bg-linear-to-r from-slate-950 via-blue-950 to-slate-900">
      <Header
        title="LOGOTIPO"
        navigationLinks={[
          { name: "HOME", link: "/" },
      ...
      <main className="flex-1 w-full bg-linear-to-r from-slate-950 via-blue-950 to-slate-900 overflow-y-auto">
        <Routes>
