...
export default function Footer() {
  return (
    <footer
      id="contatos"
      className="relative w-full py-2 bg-linear-to-r from-slate-950 via-blue-950 to-slate-900 -mt-12.5 uppercase border-t-2 border-blue-950"
    >
      {/* LOGOTIPO (DESKTOP) */}
      <div className="hidden lg:flex items-center justify-center absolute left-6 lg:left-8 xl:left-12 top-1/2 -translate-y-1/2 shrink-0">
        <img
          src="/Imagens/logotipo.png"
          alt="logotipo"
          className="w-12 md:w-16 lg:w-18 h-auto object-contain shrink-0"
        />
      </div>
        ...
        <div className="flex flex-col lg:flex-row items-center justify-center gap-8 lg:gap-16 pt-4">
          ...
          <div className="flex lg:hidden items-center justify-center shrink-0">
            <img
              src="/Imagens/logotipo.png"
              alt="logotipo"
              className="w-12 md:w-16 h-auto object-contain shrink-0"
            />
          </div>
          ...
          <div className="flex flex-col lg:flex-row items-center lg:items-center gap-8 lg:gap-14 w-full lg:w-auto">
            ...
            <div className="flex flex-col items-center lg:items-start justify-center gap-2 w-full lg:w-60">
              ...
              <div className="flex justify-center lg:justify-start gap-2 mt-1">
                <a
                  href="https://www.facebook.com/groups/ttesp/"
                  target="_blank"
                ...
                <a
                  href="https://www.instagram.com/ec.taubate/"
                  target="_blank"
                  rel="noopener noreferrer"
                ...
                <a
                  href="https://www.youtube.com/hashtag/taubate"
                  target="_blank"
                  rel="noopener noreferrer"
